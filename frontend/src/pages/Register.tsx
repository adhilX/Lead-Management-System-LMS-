  ...
  return (
    <div className="min-h-screen flex bg-slate-50">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-black relative overflow-hidden">
        ...
        <div className="absolu>te bottom-0 right-0 translate-x-1/2 translate-y-1/2 w-96 h-96 bg-gray-700 rounded-full blur-3xl opacity-30"></div>
      </div>
        ...
        <div className="w-full max-w-sm space-y-6 bg-white p-8 rounded-2xl shadow-xl border border-slate-100">
          ...
          <form className="mt-4 space-y-3" onSubmit={handleSubmit(onSubmit)}>
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  autoComplete="name"
                  {...register('name')}
                  className={`appearance-none block w-full px-4 py-2 border ${errors.name ? 'border-red-500' : 'border-slate-300'} rounded-lg focus:ring-2 focus:ring-black focus:border-black placeholder-slate-400 transition-colors`}
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  type="tel"
                  {...register('phone')}
                  className={`appearance-none block w-full px-4 py-2 border ${errors.phone ? 'border-red-500' : 'border-slate-300'} rounded-lg focus:ring-2 focus:ring-black focus:border-black placeholder-slate-400 transition-colors`}
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`appearance-none block w-full px-4 py-2 border ${errors.confirmPassword ? 'border-red-500' : 'border-slate-300'} rounded-lg focus:ring-2 focus:ring-black focus:border-black placeholder-slate-400 transition-colors`}
                  placeholder="••••••••"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className={`w-full flex justify-center py-2 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-black hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black transition-all ${loading ? 'opacity-70 cursor-not-allowed' : ''} mt-4`}
            >
              {loading ? (
